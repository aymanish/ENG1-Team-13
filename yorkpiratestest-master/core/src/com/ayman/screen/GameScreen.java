 ...
 */
        ...
        game.camera.viewportWidth = Gdx.graphics.getWidth()/1.75f;// /1.75f
        game.camera.viewportHeight = Gdx.graphics.getHeight()/1.75f; // /1.75f
        game.camera.update();
        ...
        //Draw barrier if boss locked and restrict player:
        game.unlockBoss();

        //game.barrier.barrier.setPosition(1452, 1380);
        //game.barrier.barrier.draw(game.batch);
        ...
        */
        ...
        game.font.draw(game.batch, "\nHP: " + game.player.HP + "\nP: " + game.player.POINTS+ "\nAMMO: " + game.player.bullets.size() + "\nSCREENX: " + Gdx.graphics.getWidth()+"\nx: "+ game.player.x+"    y: "+game.player.y+"\nUNLOCK: "+game.player.unlocked+"\nBOSSHP: "+game.Constantine.HP, game.player.x+game.player.width, game.player.y+game.player.height);
